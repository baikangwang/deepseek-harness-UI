...
export default {
  apply(ctx) {
    ...
    function openDoc(tab, current) {
      docStore.add(tab)
      if (hasEditorColumn) {
        if (layout && typeof layout.openEditor === 'function') layout.openEditor()
        return
      }
