...
let IdeService = (() => {
    ...
    return class IdeService extends _classSuper {
        static {
            ...
            __esDecorate(this, null, _newFile_decorators, { kind: "method", name: "newFile", static: false, private: false, access: { has: obj => "newFile" in obj, get: obj => obj.newFile }, metadata: _metadata }, null, _instanceExtraInitializers);
            ...
            __esDecorate(this, null, _explore_decorators, { kind: "method", name: "explore", static: false, private: false, access: { has: obj => "explore" in obj, get: obj => obj.explore }, metadata: _metadata }, null, _instanceExtraInitializers);
            ...
            __esDecorate(this, null, _gitStageAll_decorators, { kind: "method", name: "gitStageAll", static: false, private: false, access: { has: obj => "gitStageAll" in obj, get: obj => obj.gitStageAll }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, _gitUnstageAll_decorators, { kind: "method", name: "gitUnstageAll", static: false, private: false, access: { has: obj => "gitUnstageAll" in obj, get: obj => obj.gitUnstageAll }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        async listDir(path) {
            ...
            if (fs === undefined)
                throw new Error('filesystem service unavailable');
        ...
        async gitStatus(cwd) {
            if (cwd === '')
                return { branch: '', changes: [], notRepo: true, error: 'no workspace directory' };
        ...
        async gitStage(cwd, paths) {
            if (paths.length === 0)
                return { ok: false, stderr: 'no paths' };
        ...
        async gitDiscard(cwd, path, untracked) {
            if (path === '')
                return { ok: false, stderr: 'no path', path };
            if (untracked) {
                const d = await this.pwsh('Remove-Item -LiteralPath $args[0] -Recurse -Force', [path]);
                return { ok: d.ok, stderr: d.stderr, path };
            }
        ...
        async gitCommit(cwd, message) {
            ...
            if (trimmed === '')
                return { ok: false, stdout: '', stderr: 'empty commit message' };
        ...
        async search(cwd, query, caseSensitive) {
            const fs = this.ctx.fs;
            if (fs === undefined)
                return { error: 'filesystem service unavailable', matches: [], files: 0, truncated: false };
            if (query === '' || cwd === '')
                return { error: '', matches: [], files: 0, truncated: false };
            ...
            const walk = async (target) => {
                if (truncated || files >= MAX_FILES || matches.length >= MAX_MATCHES)
                    return;
                let entries;
                try {
                ...
                for (const e of entries) {
                    ...
                    if (SKIP.has(e.name))
                        continue;
                    if (e.name.length > 0 && e.name[0] === '.')
                        continue;
                    if (e.type === 'directory') {
                        await walk(e.target);
                    }
                    else if (e.type === 'file') {
                        if (typeof e.size === 'number' && e.size > 256 * 1024)
                            continue;
                        files++;
                        let text;
                        try {
