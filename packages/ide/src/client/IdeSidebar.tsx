...
export function IdeSidebar(props: IdeSidebarProps): ReturnType<typeof createElement> {
  ...
  return el('div', { className: 'dshide-region' }, el('div', { className: 'dshide-activity' }, buttons()), el('div', { className: 'dshide-content' }, active === 'sessions' ? el(SessionView, { sessions: props.sessions, workspaces: props.workspaces, wsState, sessState, settings: props.settings, home: props.home }) : active === 'files' ? el(ExplorerView, { ide: props.ide, rpc: props.rpc, openDoc: props.openDoc, root, setRoot, workspaces: items, settings: props.settings, home: props.home }) : active === 'search' ? el(SearchView, { ide: props.ide, rpc: props.rpc, openDoc: props.openDoc, sessions: props.sessions, workspaces: props.workspaces, root, settings: props.settings, home: props.home, scm: props.scm }) : el(ScmView, { ide: props.ide, rpc: props.rpc, openDoc: props.openDoc, sessions: props.sessions, workspaces: props.workspaces, root, settings: props.settings, home: props.home, scm: props.scm })))
}
